...
2. Vue2对于typescript的支持非常的有限

// Mixin缺点
1. 命名冲突
2. 不清楚暴露出来变量的作用
3. 重用到其他 component 经常会遇到问题
```
...
> 安装依赖：npm i unplugin-vue-components -D

``` js
// webpack配置（在vue.config.js中配置）
...
> 安装依赖：npm  install  unplugin-auto-import  -D
...
<img src="https://vitejs.cn/assets/bundler.37740380.png" style="width:500px;height:280px;float:left" /><img src="https://vitejs.cn/assets/esm.3070012d.png" style="width:480px;height:280px" />
...
![vue2.x的生命周期](./image/生命周期-解释版.png)
![vue3.0的生命周期](https://cn.vuejs.org/assets/lifecycle.16e4c08e.png)
...
- 无需注册组件即可使用（在《script setup》的单文件组件中）
-
